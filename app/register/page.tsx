...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    if (!emailRegex.test(email)) {
      setMensaje('Por favor ingresá un correo electrónico válido.');
      return;
    }
    ...
    if (dbError || !usuarioInsertado) {
      setMensaje('Registrado en auth, pero error al crear en usuarios: ' + dbError?.message);
      return;
    }
    ...
    if (membresiaError) {
      setMensaje('Usuario creado pero error al asignar membresía: ' + membresiaError.message);
      return;
    }
